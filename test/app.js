    ...
    context('when not signed in', () => {
        ...
        context('when POSTing to /register', () => {
            shouldValidateParams('/register', [
                ...
                {username: valid_username, password: 123456789, email: valid_email},
                {username: false, password: valid_password, email: valid_email},
                {username: valid_username, password: valid_password, email: null},
                {username: valid_username, password: valid_password, email: valid_email, foo: 'bar'}
            ])
